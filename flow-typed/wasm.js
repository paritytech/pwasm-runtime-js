...
declare class WebAssembly$Instance {
  ...
  +exports: {
    [exportedFunction: string]: ExportedFunctionExoticObject,
...
declare function WebAssembly$instantiate(moduleObject: WebAssembly$Module, importObject?: ImportObject): Promise<ResultObject>;
